...
def index():
    ...
    return "<h1>! ASSIGNMENT III !</h1><br> <a href='/login'><button>GOOGLE</button></a> <br><br> <a href='/login/github''><button>GITHUB</button></a> <br><br> <a href='/login/linkedin'><button>LINKEDIN</button></a> <br><br> <a href='login/facebook'><button>FACEBOOK</button></a>"
